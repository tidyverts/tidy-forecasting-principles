...
To ensure consistency between simulation methods, `fablelite` tools prepare this data so that the `simulate` method for a model can expect to receive `new_data` in this format:
